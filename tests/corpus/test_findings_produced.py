"""What Tasks 3.2 and 3.3's checks really produce on the two corpus fixtures.
...
from findings_fixtures import corpus_findings, corpus_static_check_findings
...
def test_the_permission_check_ran_on_the_support_agent_and_found_nothing() -> None:
    """Neither fixture uses a shell, interpreter or requests tool, so zero is the honest result.
