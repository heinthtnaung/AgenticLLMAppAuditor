...
Four test files drive the CLI or its dependency rules. The argv shim, the
`<artifacts-dir>/<app>/<name>` layout and the Syft stub are spelled once here,
so a change to any of them is a change in one place rather than four.
"""
