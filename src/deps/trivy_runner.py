...
A thin wrapper, offline by construction. It runs the tool, reads the JSON and
returns advisories keyed by the versioned purl they were raised against, so a
later step can join them to the components Syft catalogued. Nothing here scores
anything, and Trivy's own field names stop at this module.
