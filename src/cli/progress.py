...
queue on one GPU, so a second member multiplies the wall clock rather than
adding to it. Around seventy-seven minutes of silence is indistinguishable from
a hung run.
